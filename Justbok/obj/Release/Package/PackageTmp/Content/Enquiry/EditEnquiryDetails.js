$(document).ready(function () {
    ...
    $('#btnEditEnquiry').click(function(){if(ValidateEnquiryForm()){SaveEnquiry();}});
...
function SaveEnquiry() {
    ...
    var jsonObject = {
        ...
        EnquiryId: $('#txtEnquiryId').val(),FirstName: $('#txtFirstName').val(), LastName: $('#txtLastName').val(), MobileNumber: $('#txtMobileNo').val(),
...
function RedirectEnquiry() {
    LoadPage('/Enquiry/EnquiryList/', 'Justbok | Enquiry List');
    return false;
}
