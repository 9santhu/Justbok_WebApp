$(document).ready(function () {
    ...
    $(document).on("click", "#btnUpdateProduct", function () { if (ValidateProduct()) { UpdateProduct(); } });
    HideLoader();
});
...
function UpdateProduct() {
    ...
    var jsonObject = {
        ProductId: $('#txtProductid').val(),BrandName: $('#txtBrandName').val(), ProductName: $('#txtProductname').val(), Price: $('#txtPrice').val(),
