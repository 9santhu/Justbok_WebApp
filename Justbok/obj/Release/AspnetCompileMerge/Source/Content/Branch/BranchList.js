...
+ "<td> <i class='fa fa-fw fa-edit btnEditBranch' onclick='return EditBranch(this)' data-toggle='modal' data-target='#modal-branch'></i><i class='fa fa-fw fa-close btnDeleteBranch'  onclick='return DeleteBranch(this)'></i></td>"
+ "</tr>";
