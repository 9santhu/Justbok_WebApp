            ...
            if (data != null && data.Pages > 0) {
                $.each(data.Result, function (i, item) {
                    ...
                    var rows = '<tr role="row" class="odd">'
                     ...
                     + '<a href="" class="btn btn-primary btn-xs btn-flat"  onclick="return RedirectToPayment(' + item.MemberID + ')"><span class="glyphicon glyphicon-credit-card" ></span> Payment</a> </td>'
            ...
            if (data != null && data.Pages > 0) {
                $.each(data.Result, function (i, item) {
                    ...
                    var rows = '<tr role="row" class="odd">'
                     ...
                     + '<td>' + note + '</td>'
                       + '<td> <a href="" class="btn btn-success btn-xs btn-flat" onclick="return EditMember(' + item.MemberID + ')"><span class="glyphicon glyphicon-edit"></span> Edit </a> '
                     + '<a href="" onclick="return RedirectToPayment(' + item.MemberID + ')" class="btn btn-primary btn-xs btn-flat"><span class="glyphicon glyphicon-credit-card" ></span>  Payment</a> </td>'
                        + '</tr >';
                    $('#tblMembershipList tbody').append(rows);
                });
