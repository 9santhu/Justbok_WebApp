...
function SaveSupplier() {
    ShowLoader();
    var jsonObject = {
        CompanyName: $('#txtCompanyName').val(), RegistrationNumber: $('#txtRegno').val(), FirstName: $('#txtFirstName').val(),
...
function ValidateSupplier() {
    ...
    if ($('#txtEmail').val() == "") {
        ...
        $('#txtEmail').parent().append(errorSpan.replace(/{{Message}}/g, "Please Enter LastName"));
